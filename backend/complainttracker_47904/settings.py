"""
Django settings for complainttracker_47904 project.
...
ROOT_URLCONF = 'complainttracker_47904.urls'
...
WSGI_APPLICATION = 'complainttracker_47904.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "complainttracker_47904 API",
    "DESCRIPTION": "API documentation for complainttracker_47904 App",
    "VERSION": "v1",
}
